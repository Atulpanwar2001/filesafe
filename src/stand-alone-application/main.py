...
def opengithub(event):
	webbrowser.open_new(r"https://github.com/Atulpanwar2001/filesafe")

def openparthlinkedin(event):
	webbrowser.open_new(r"https://www.linkedin.com/in/prabhatkumar-/")

def openhardiklinkedin(event):
	webbrowser.open_new(r"https://www.linkedin.com/in/atul-panwar-0a94ab1b7/")
'''
-----------------------------------------------------------------
UPDATE ENTRY LABELS
-----------------------------------------------------------------
